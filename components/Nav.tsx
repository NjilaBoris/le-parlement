      ...
      <div className="w-full h-full bg-white">
        <div className="flex items-center py-4  justify-between w-[calc(100%-4rem)] mx-auto h-full max-lg:hidden">
          ...
          <div className="flex items-center gap-3">
            <p className="font-inter text-[#657285] text-[0.75rem]">
              {location}
            </p>
            <button className="border-[#65728533] cursor-pointer p-2 hidden w-fit xl:hidden bg-[#6572851a] border  lg:inline-flex items-center justify-center h-full rounded-full ">
              <IconSearch className="size-4 text-[#657285] " />
            </button>
          </div>
        </div>
      </div>
          ...
          <Link href="/">
            <div className="flex items-center self-center  gap-1 font-inter">
              ...
              <p className="text-[1rem] font-bold md:text-[1.3rem] text-white  uppercase flex items-center">
                <span
                  className={`opacity-50 transition duration-200 ease-in ${isOpen && "text-black opacity-100"}`}
                >
                  le parle
                </span>{" "}
                <span
                  className={`opacity-100 transition duration-200 ease-in ${isOpen && "text-[#cc0000]"}`}
                >
                  ment
                </span>
              </p>
